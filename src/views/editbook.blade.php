	...
	<body>
		...
		<form class="register-form" method="POST" action="{{ route('flipbook.update',$flipbook->id) }}" enctype="multipart/form-data">
                                 ...
                                 <div class="row">
                                  ...
                                  <label><span class="required">*</span> Book Name</label> </div> <div class="col-lg-3">
                                  <input class="input-block-level" type="text" placeholder="* Flip Book Name" name="book_name" value="{{ $flipbook->name }}"></div></div>

                                   <div class="row">
                                                                        <div class="col-lg-3">
                                   <label><span class="required">*</span> Book Description</label></div>
                                                             <div class="col-lg-3"><input class="input-block-level" type="text" placeholder="* Flip Book Desc" name="desc" value="{{ $flipbook->desc }}"></div></div>
